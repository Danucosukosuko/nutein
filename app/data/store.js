      ...
      if (!store) {
        store = new Store({
          ...
          defaults: {
            ...
            nuteinDevDisableAnimations: false,
            nuteinDevReduceMotion: false,
            nuteinDevShowDebugOutline: false,
            nuteinDevHighContrast: false,
            nuteinDevMonoFont: false,
            nuteinDevCompactPlayer: false,
            nuteinDevHideHeaderPromo: false,
            nuteinDevHideSocialShare: false,
            nuteinDevHideBadges: false,
            nuteinDevHideFooterLinks: false,
          },
        });
      }
      return store;
